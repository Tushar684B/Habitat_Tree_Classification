...
\'a0 var qa = image.select('QA60');\
\'a0 var cloudBitMask = 1 << 10;\
\'a0 var cirrusBitMask = 1 << 11;\
\'a0 var mask = qa.bitwiseAnd(cloudBitMask).eq(0)\
\'a0 \'a0 \'a0 .and(qa.bitwiseAnd(cirrusBitMask).eq(0));\
\
\'a0 return image.updateMask(mask).divide(10000);\
\}\
var period_of_interest = ee.Filter.date('2019-7-01', '2019-10-31');\
var dataset = ee.ImageCollection('COPERNICUS/S2_SR')\
\'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 .filter(period_of_interest)\
\'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 .filterBounds(roi)\
\'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 .filter(ee.Filter.lt('CLOUDY_PIXEL_PERCENTAGE',10))\
\'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 .map(maskS2clouds);\
var base_bands = dataset.mean().select(["B2","B3","B4","B5","B6","B8"])\
var addNDVI = function(image) \{var ndvi = image.normalizedDifference(['B8', 'B4'])\
\'a0 .rename('NDVI')\
\'a0 .copyProperties(image,['system:time_start']);\
\'a0 return image.addBands(ndvi);\
\};\
\
var addBSI = function(image) \{var bsi = image.expression(\
\'a0 '((RED + SWIR) - (NIR + BLUE)) / ((RED + SWIR) + (NIR + BLUE)) ', \
\'a0 \{\
\'a0 \'a0 'RED': image.select('B4'), \
\'a0 \'a0 'BLUE': image.select('B2'),\
\'a0 \'a0 'NIR': image.select('B8'),\
\'a0 \'a0 'SWIR': image.select('B11'),\
\'a0 \}\
)\
\'a0 .rename('BSI')\
\'a0 .copyProperties(image,['system:time_start']);\
\'a0 return image.addBands(bsi);\
\};\
\
\
...
\'a0 '((NIR - RED) / (NIR + RED))  ', \
\'a0 \{\
\'a0 \'a0 'NIR': rapideye.select('b5'), \
\'a0 \'a0 \
\'a0 \'a0 'RED': rapideye.select('b1'),\
\'a0 \}\
).rename('NDVI_RE')\
...
// \'a0 \'a0 'NIR': rapideye.select('b5'), \
\'a0 \'a0 \
// \'a0 \'a0 'RE': rapideye.select('b4'),\
// \'a0 \}\
// ).rename('NDRE')\
// var rededge = rapideye.select('b4').rename('REDEDGE')\
\
// var gcc = rapideye.expression(\
// \'a0 '((green) / (blue + green+ red))  ', \
// \'a0 \{\
// \'a0 \'a0 'red': rapideye.select('b1'), \
\'a0 \'a0 \
// \'a0 \'a0 'green': rapideye.select('b2'),\
\'a0 \'a0 \
\'a0 \'a0 \
// \'a0 \'a0 'blue': rapideye.select('b3'),\
// \'a0 \}\
// ).rename('GCC')\
...
\'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 .filter(period_of_interest)\
\'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 .filterBounds(geometry)\
\'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 .filter(ee.Filter.lt('CLOUDY_PIXEL_PERCENTAGE',10))\
\'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 \'a0 .map(maskS2clouds);\
var base_bands = dataset.mean().select(["B2","B3","B4","B5","B6","B8"])\
var addNDVI = function(image) \{var ndvi = image.normalizedDifference(['B8', 'B4'])\
